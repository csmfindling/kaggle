# source =  https://github.com/kundan2510/resnet152-pre-trained-imagenet/blob/master/ImageNet%20Pretrained%20Network%20(ResNet-152).ipynb
...
def build_model(input_var):
    ...
    net = {}
    net['input'] = InputLayer((None, 3, 256, 256), input_var)
    ...
    net['fc1000'] = DenseLayer(net['pool5'], num_units=17, nonlinearity=None)
    net['prob'] = NonlinearityLayer(net['fc1000'], nonlinearity=sigmoid)
